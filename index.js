...
const billboard = "***************************************************************\n*                                                             *\n*                                                             *\n*   #######                                                   *\n*   #       #    # #####  #       ####  #   # ###### ######   *\n*   #       ##  ## #    # #      #    #  # #  #      #        *\n*   #####   # ## # #    # #      #    #   #   #####  #####    *\n*   #       #    # #####  #      #    #   #   #      #        *\n*   #       #    # #      #      #    #   #   #      #        *\n*   ####### #    # #      ######  ####    #   ###### ######   *\n*                                                             *\n*   #     #                                                   *\n*   ##   ##   ##   #    #   ##    ####  ###### #####          *\n*   # # # #  #  #  ##   #  #  #  #    # #      #    #         *\n*   #  #  # #    # # #  # #    # #      #####  #    #         *\n*   #     # ###### #  # # ###### #  ### #      #####          *\n*   #     # #    # #   ## #    # #    # #      #   #          *\n*   #     # #    # #    # #    #  ####  ###### #    #         *\n*                                                             *\n*                                                             *\n***************************************************************\n";
const options = ["View all employees", "Add employee", "Update employee role", "View all roles", "Add role", "Delete role", "View all departments", "Add department", "Delete department", "Quit"];
